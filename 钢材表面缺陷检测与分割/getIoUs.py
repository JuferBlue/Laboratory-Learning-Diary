...
if __name__ == '__main__':
    iou1, iou2, iou3 = get_ious_dir('./test_ground_truths', './baseline_predictions')
    print(iou1, iou2, iou3)
    print((iou1 + iou2 + iou3)/3)